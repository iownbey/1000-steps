...
Area_Underworld.text = {
  ...
  emerySpeak: [
    ...
    {
      text: "I'm think my uncle Thaddeus is down there somewhere.",
      aExpr: expr.emery.unsure,
    },
    {
      text: 'Also, my research indicates that the people down there REALLY like these things called "Skullberries".',
      aExpr: expr.emery.happy,
    },
    [
      "That's all I know. People don't usually leave the underworld, so information about it is scarce.",
    ],
    {
      text: "I wish I knew where the exit was. Maybe there'll be someone you can ask for directions?",
      aExpr: expr.emery.unsure,
    },
    {
      text: "Anyway, the world needs you, Harbinger!",
      aExpr: expr.emery.happy,
    },
  ...
  meetSkeletonsText: [
    ...
    {
      text: "It's the talking nightlight himself!",
      aExpr: expr.skeleton.happy,
    },
    ...
    {
      text: "...we'd rather not see the darkness terrorize the earth for a kajillion years...",
      aExpr: expr.skeleton.secretive,
    },
    { text: "Definitely not my definition of fun.", aExpr: expr.arnold.stoic },
    {
      text: "So, please don't chop us up into smithereens.",
      aExpr: expr.skeleton.happy,
    },
    { text: "That doesn't sound very fun either.", aExpr: expr.arnold.stoic },
    {
      text: "You should ask them for directions! They seem nice.",
      aExpr: expr.emery.happy,
    },
    "You ask.",
    {
      text: "Well, to do that you'd have to fight King Thaddeus.",
      aExpr: expr.skeleton.happy,
    },
    {
      text: "You've got to be kidding me. Thaddeus is the king?",
      aExpr: expr.emery.annoyed,
    },
    {
      text: "Basically, you keep walking straight until you see him.",
      aExpr: expr.skeleton.happy,
    },
    ["You literally CAN'T miss him."],
    ["..."],
    {
      text: "You aren't going to fight him are you?",
      aExpr: expr.skeleton.confused,
    },
  ...
  meetSkeletons2Text: [
    ...
    {
      text: "This stuff was not designed for your eye.",
      aExpr: expr.arnold.berried,
    },
    ...
    {
      text: "Think you could patch him up with some of your healing magic?",
      aExpr: expr.skeleton.scared,
    },
    { text: "...", sExpr: expr.arnold.berried },
    text.break,
    ...
    {
      text: "Yes. back to my unusually peachy self.",
      aExpr: expr.arnold.stoic,
    },
    { text: "Thank you so much, Harbinger!", aExpr: expr.skeleton.happy },
    {
      text: "If only there was some way we could repay you...",
      aExpr: expr.skeleton.confused,
    },
    "...",
    {
      text: "We could give him some of our skullberries.",
      aExpr: expr.arnold.stoic,
    },
  ...
  postFightThaddeus: [
    ...
    text.break,
    [
      "Now that you've inherited the birthright, the door will be unlocked.",
      expr.arnold.stoic,
    ],
