class Area_Aorta extends Area {
  ...
  static async meetTroll() {
    contentManager.clear();
    contentManager.add(
      $('<div class="monster"><div class="troll"></div></div>')
    );
  ...
  static unlockCharge = Area.getUnlockEvent(
    1,
    "CHARGE",
  ...
  static unlockStun = Area.getUnlockEvent(
    1,
    "STUN",
  ...
  static next = Area.getNextAreaEvent("Area_Underworld");
}
