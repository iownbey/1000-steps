...
ex.abigail = {
  happy: faceHandler.registerExpression(7, 1),
  sad: faceHandler.registerExpression(9, 1),
  sadEyeContact: faceHandler.registerExpression(11, 1),
};
...
tex.aorta = {
  ...
  trollFoundText: [
    ...
    [
      "Imagine what King Amadeus will say when I stop you...",
      expr.troll.default,
    ],
  ],
  ...
  meetAmadeusText: [
    ...
    ["...really?..."],
    {
      text: "A TIME SHARE IN LOS ANGELES!!!",
      aExpr: expr.amadeus.onPhoneBlownAway,
    },
    {
      text: "Sorry, harbinger, your untimely demise will have to wait.",
      aExpr: expr.amadeus.smug,
    },
  ...
  talkToAmadeusText: [
    ...
    {
      text: "So now I'm actually going to finish...",
      aExpr: expr.amadeus.smug,
    },
    { text: "*phone rings again*", sFX: "ringtone" },
    {
      text: "Oh, for the love of crying out loud.",
      aExpr: expr.amadeus.embarrased,
    },
    ...
    {
      text: "Looks like you're off the hook for now, Harbinger.",
      aExpr: expr.amadeus.determined,
    },
    ["But next time..."],
  ...
  amadeusFight: Object.freeze({
    ...
    banter3: [["Gotcha.", expr.amadeus.smug]],
