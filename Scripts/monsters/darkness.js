class Darkness extends Monster {
    ...
    async attack3() {
        ...
        for (var i =0; i < 10; i++)
        {
            ...
            points.push(new DarknessSwordFlashPoint(0,0,Math.random() * Math.PI * 2,intervals[i+1],delay))
        }
...
Darkness.swordPath = "m 0 -320 l 40 40 l 0 260 l 60 0 l -20 40 l -40 0 l -20 20 l 0 60 l -20 20 l -20 -20 l 0 -60 l -20 -20 l -40 0 l -20 -40 l 60 0 l 0 -260 l 40 -40 z m 0 290 a 10 10 90 0 0 0 60 a 10 10 90 0 0 0 -60 z m -90 50 l -20 -40 l -10 0 l 20 40 z m 180 0 l 20 -40 l 10 0 l -20 40 z"
