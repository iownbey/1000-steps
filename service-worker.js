...
const PRECACHE_URLS = [
  ...
  './Old/globalstyles.css',
  './Old/index.html',
  './Old/outside.png',
  './Old/splashstyles.css',
  './Old/tunnel.png',
  './Old/wall.png',
  './Old/wrapper.html',
  './PWA/icon.svg',
  ...
  './Sounds/darkness/attack-choir.flp',
  './Sounds/darkness/attack-choir.wav',
  './Sounds/darkness/attack-slash.flp',
  './Sounds/darkness/attack-slash.mp3',
  './Sounds/darkness/attack-slash.wav',
  './Sounds/darkness/sayonara.mp3',
  './Sounds/darkness/sayonara.wav',
  './Sounds/FL Project Files/accordion.flp',
  './Sounds/FL Project Files/chain.flp',
  './Sounds/FL Project Files/darkness-fight.flp',
  './Sounds/FL Project Files/darkness-sad.flp',
  './Sounds/FL Project Files/darkness.flp',
  './Sounds/FL Project Files/master-sponge.flp',
  './Sounds/FL Project Files/ocean.flp',
  './Sounds/FL Project Files/thaddeus.flp',
